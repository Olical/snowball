...
public class Porcupine {
     ...
     * @throws Exception if there is an error while initializing Porcupine.
     */
    public Porcupine(
            String modelFilePath,
            String keywordFilePath,
            float sensitivity) throws Exception {
        numberKeywords = 1;
    ...
    public Porcupine(
            ...
            float[] sensitivities) throws Exception {
     ...
     * @throws Exception if there is an error while processing the audio sample.
     */
     ...
     * @throws Exception if there is an error while processing the audio sample.
     */
    public int processFrameMultipleKeywords(short[] pcm) throws Exception {
        try {
